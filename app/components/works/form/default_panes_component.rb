...
module Works
  module Form
    ...
    class DefaultPanesComponent < ApplicationComponent
      def initialize(component:, form:, form_id:, work_presenter:, # rubocop:disable Metrics/ParameterLists
                     discard_draft_form_id:, active_tab_name:, work_form:,
                     work_content:, collection:)
        @component = component
        @form = form
        @form_id = form_id
      ...
      attr_reader :component, :form, :form_id, :work_presenter, :discard_draft_form_id, :active_tab_name, :work_form,
                  :work_content, :collection
