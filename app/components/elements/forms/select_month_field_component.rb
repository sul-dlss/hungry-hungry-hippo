...
module Elements
  module Forms
    # Component for form month fields
    # Note that this uses select_month, which is not called on a form builder instance.
    # Thus, some of the machinery of the form builder is provided below.
    class SelectMonthFieldComponent < FieldComponent
      def value
