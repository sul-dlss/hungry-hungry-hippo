...
module ToWorkForm
  ...
  class Mapper
    ...
    def params # rubocop:disable Metrics/AbcSize
      {
        ...
        contact_emails_attributes: ToForm::ContactEmailsMapper.call(cocina_object:, deposits_contact_email:),
    ...
    def deposits_contact_email
      Collection.find_by!(druid: collection_druid).deposits_contact_email
    end
