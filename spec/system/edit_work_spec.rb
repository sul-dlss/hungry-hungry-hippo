...
RSpec.describe 'Edit a work' do
  ...
  shared_examples 'edits_a_work' do
    it 'edits a work' do
  ...
  context 'when the logged in user is a collection depositor' do
    before do
    ...
    it_behaves_like 'edits_a_work'
  end

  context 'when the logged in user is a collection manager' do
  ...
  context 'when the logged in user is the collection owner' do
    before do
      collection = create(:collection,
                          user: collection_owner,
                          druid: collection_druid_fixture,
