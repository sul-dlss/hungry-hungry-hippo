...
RSpec.describe 'Edit a work' do
  ...
  it 'edits a work' do
    ...
    expect(page).to have_text(updated_abstract)
    expect(page).to have_text(updated_keywords.first)
    expect(page).to have_text('Leland Stanford Jr.')
    expect(page).to have_text('Some other organization')
    expect(page).to have_text('0001-0002-0003-0004')
    expect(page).to have_text(citation_fixture)
    expect(page).to have_text('Immediately')
