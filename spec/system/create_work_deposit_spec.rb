...
RSpec.describe 'Create a work deposit' do
  ...
  context 'when creating a new work' do
    ...
    it 'creates and deposits a work' do
      ...
      click_link_or_button('Next')
      expect(page).to have_css('.nav-link.active', text: 'Citation for this deposit')

      # Filling in citation
      expect(page).to have_text('Citation for this')
      ...
      # Clicking on Next 4 times to go to Deposit
      click_link_or_button('Next')
      click_link_or_button('Next')
      click_link_or_button('Next')
      click_link_or_button('Next')
