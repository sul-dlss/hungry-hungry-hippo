...
RSpec.describe 'Create a work deposit' do
  ...
  shared_examples 'deposits_a_work' do
  ...
  context 'when the user is the collection owner' do
    before do
      create(:collection, user: collection_owner, druid: collection_druid_fixture)
      sign_in(collection_owner)
    end

    it_behaves_like 'deposits_a_work'
  end
  ...
  context 'when the user is a collection manager' do
    ...
    before do
      create(:collection, user: collection_owner, managers: [collection_manager], druid: collection_druid_fixture)
  ...
  context 'when the user is a collection depositor' do
    ...
    before do
      create(:collection, user: collection_owner, depositors: [collection_depositor], druid: collection_druid_fixture)
  ...
  context 'when the user has no collection roles' do
    ...
    it 'does not allow the user to deposit' do
      visit root_path
      expect(page).to have_no_text('Deposit to this collection')
    end
  end
end
