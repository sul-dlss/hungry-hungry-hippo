...
RSpec.describe 'Create a work deposit' do
  ...
  context 'when creating a new work' do
    ...
    it 'creates and deposits a work', :dropzone do
      ...
      expect(page).to have_css('li.list-group-item', text: 'Stanford University')
      ...
      expect(page).to have_field('Full link for a related work (e.g., DOI, arXiv, PMID, PURL, or other URL). Include "https://".',
                                 type: 'radio',
                                 checked: true)
      ...
      expect(page).to have_field('Full link for a related work (e.g., DOI, arXiv, PMID, PURL, or other URL). Include "https://".',
                                 disabled: true)
      choose('Full link for a related work (e.g., DOI, arXiv, PMID, PURL, or other URL). Include "https://".')
