...
RSpec.describe Works::Edit::GlobusComponent, type: :component do
  ...
  it 'renders globus links' do
    ...
    expect(page).to have_link('Upload from my computer', href: 'https://app.globus.org/file-manager?destination_id=fake7087-d32d-4588-8517-b2d0d32d53b8&destination_path=/uploads/jstanford/new')
    expect(page).to have_link('Stanford Google Drive', href: 'https://app.globus.org/file-manager?destination_id=fake7087-d32d-4588-8517-b2d0d32d53b8&destination_path=/uploads/jstanford/new&origin_id=e1c8858b-d5aa-4e36-b97e-95913047ec2b')
    ...
    expect(page).to have_button('I am done uploading to Globus')
  end
end
