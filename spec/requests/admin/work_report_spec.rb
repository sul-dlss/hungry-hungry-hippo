  ...
  describe 'when submitting the form' do
    ...
    context 'when form is valid' do
      it 'redirects to new form' do
        post '/admin/work_report', params: { admin_work_report: { date_created_start: nil, date_created_end: nil,
                                                                  date_modified_start: nil, date_modified_end: nil,
                                                                  collection_ids: [''],
                                                                  draft_not_deposited_state: false,
                                                                  pending_review_state: false, returned_state: false,
                                                                  deposit_in_progress_state: false,
    ...
    context 'when form is not valid' do
      it 'redirects to new form' do
        post '/admin/work_report', params: { admin_work_report: { date_created_start: 'not a date',
