...
RSpec.describe DepositWorkJob do
  ...
  context 'when a new work' do
    ...
    it 'registers a new work' do
      ...
      expect(Turbo::StreamsChannel).to have_received(:broadcast_refresh_to).with(work)
  ...
  context 'when an existing work with changed cocina object and depositing' do
    ...
    context 'when datacite validation fails' do
      ...
      it 'raises an error and notifies Honeybadger' do
        ...
        end.to raise_error(Cocina::Models::ValidationError, /Datacite validation failed/)
  ...
  context 'when review requested' do
    ...
    it 'registers a new work' do
      described_class.perform_now(work_form:, work:, deposit: true, request_review: true, current_user:, ahoy_visit:)
